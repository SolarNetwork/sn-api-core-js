...
function populateProperties$1(obj, names, values, type) {
...
var StreamAggregateDatum = /*#__PURE__*/function () {
  ...
  _createClass(StreamAggregateDatum, [{
    ...
    value: function toObject(meta) {
      ...
      populateProperties$1(obj, meta.instantaneousNames, this.iProps, DatumSamplesTypes.Instantaneous);
      populateProperties$1(obj, meta.accumulatingNames, this.aProps, DatumSamplesTypes.Accumulating);
    ...
    function (_superclass) {
      ...
      _createClass(_class, [{
        ...
        value: function toObject() {
          return _get(_getPrototypeOf(_class.prototype), "toObject", this).call(this, this._meta);
        }
      }]);
