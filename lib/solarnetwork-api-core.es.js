...
class Instruction {
    ...
    constructor(info) {
        this.id = info.id;
        this.created = dateParser(info.created) || new Date();
        this.nodeId = info.nodeId;
        this.topic = info.topic;
        this.instructionDate = dateParser(info.instructionDate) || new Date();
        this.state =
            InstructionState.valueOf(info.state) || InstructionStates.Unknown;
        this.statusDate = dateParser(info.statusDate) || new Date();
