// https://github.com/SolarNetwork/sn-api-core-js Version 0.4.1. Copyright 2017 Matt Magoffin.
   ...
   */
     ...
     */
				...
				value: function listDatumUrl(datumFilter, sorts, pagination) {
					...
					var params = datumFilter ? datumFilter.toUriEncoding() : '';
					if (Array.isArray(sorts)) {
						sorts.forEach(function (sort, i) {
							if (sort instanceof SortDescriptor) {
								if (params.length > 0) {
...
export { Aggregations, Aggregation, AuthTokenStatuses, AuthTokenStatus, AuthTokenTypes, AuthTokenType, DatumFilter, GeneralMetadata, stringMapToObject, objectToStringMap, InstructionStates, InstructionState, LocationPrecisions, LocationPrecision, Pagination, SecurityPolicy, SecurityPolicyBuilder, SortDescriptor, timestampFormat, dateTimeFormat, dateTimeUrlFormat, dateFormat, timestampParse, dateTimeParse, dateParser, iso8601Date, isoParse as dateTimeUrlParse, isoParse as dateParse, AuthorizationV2Builder, DatumMetadataUrlHelperMixin, DatumMetadataUrlHelper, Environment, HttpHeaders, HttpMethod, NodeDatumUrlHelperMixin, NodeDatumUrlHelper, NodeInstructionUrlHelperMixin, NodeInstructionUrlHelper, instructionParameter, NodeMetadataUrlHelperMixin, NodeMetadataUrlHelper, NodeUrlHelperMixin, QueryUrlHelperMixin, SolarQueryDefaultPath, SolarQueryPathKey, SolarQueryApiPathV1, SolarQueryPublicPathKey, UserAuthTokenUrlHelperMixin, UserAuthTokenUrlHelper, UserUrlHelperMixin, SolarUserDefaultPath, SolarUserPathKey, SolarUserApiPathV1, UrlHelper, urlQuery, ComparableEnum, Configuration, Enum, MultiMap, PropMap };
