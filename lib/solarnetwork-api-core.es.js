// https://github.com/SolarNetwork/sn-api-core-js Version 0.15.1-dev.0. Copyright 2019 Matt Magoffin.
import { ascending, max, sum } from 'd3-array';
import { nest } from 'd3-collection';
import { utcDay, utcHour, utcMinute, utcMonth, utcYear } from 'd3-time';
 ...
 */
var CombiningType = function (_Enum) {
  inherits(CombiningType, _Enum);
  ...
  function CombiningType(name) {
    classCallCheck(this, CombiningType);

    var _this = possibleConstructorReturn(this, (CombiningType.__proto__ || Object.getPrototypeOf(CombiningType)).call(this, name));
  ...
  createClass(CombiningType, null, [{
    key: 'enumValues',
    value: function enumValues() {
 ...
 */
var DatumAuxiliaryType = function (_Enum) {
  inherits(DatumAuxiliaryType, _Enum);
  ...
  function DatumAuxiliaryType(name) {
    classCallCheck(this, DatumAuxiliaryType);

    var _this = possibleConstructorReturn(this, (DatumAuxiliaryType.__proto__ || Object.getPrototypeOf(DatumAuxiliaryType)).call(this, name));
  ...
  createClass(DatumAuxiliaryType, null, [{
    key: 'enumValues',
    value: function enumValues() {
...
var Pagination = function () {
     ...
     */
    function Pagination(max$$1, offset) {
        classCallCheck(this, Pagination);

        this._max = max$$1 > 0 ? +max$$1 : 0;
        ...
        */
        ...
        value: function toUriEncoding(propertyName, callbackFn) {
            ...
            var _loop = function _loop(_k) {
                ...
                var v = _this.props[_k];
                var forceMultiKey = false;
                if (callbackFn) {
                    var kv = callbackFn(_k, v);
                    if (kv === null) {
                        return 'continue';
                ...
                if (typeof v.toUriEncoding === 'function') {
                    result += v.toUriEncoding(propertyName ? encodeURIComponent(propertyName) + '.' + _k : _k);
                    return 'continue';
                }
                ...
                result += encodeURIComponent(_k) + '=';
                if (Array.isArray(v)) {
                    v.forEach(function (e, i) {
                        if (i > 0) {
                            result += forceMultiKey ? '&' + encodeURIComponent(_k) + '=' : ',';
                        }
 ...
 */
var DatumReadingType = function (_Enum) {
  inherits(DatumReadingType, _Enum);
  ...
  function DatumReadingType(name, key) {
    classCallCheck(this, DatumReadingType);

    var _this = possibleConstructorReturn(this, (DatumReadingType.__proto__ || Object.getPrototypeOf(DatumReadingType)).call(this, name));
...
var DatumReadingTypeValues = Object.freeze([new DatumReadingType('CalculatedAt', 'at'), new DatumReadingType('CalculatedAtDifference', 'atd'), new DatumReadingType('NearestDifference', 'diff')]);
...
var BitmaskEnum = function (_Enum) {
	inherits(BitmaskEnum, _Enum);
  ...
  */
	function BitmaskEnum(name, bitNumber) {
		classCallCheck(this, BitmaskEnum);

		var _this = possibleConstructorReturn(this, (BitmaskEnum.__proto__ || Object.getPrototypeOf(BitmaskEnum)).call(this, name));
...
var DeviceOperatingState = function (_BitmaskEnum) {
	inherits(DeviceOperatingState, _BitmaskEnum);
  ...
  */
	function DeviceOperatingState(name, bitNumber) {
		classCallCheck(this, DeviceOperatingState);

		var _this = possibleConstructorReturn(this, (DeviceOperatingState.__proto__ || Object.getPrototypeOf(DeviceOperatingState)).call(this, name, bitNumber));
  ...
  */
	...
	createClass(DeviceOperatingState, [{
		key: "code",
		get: function get$$1() {
...
var SkyCondition = function (_BitmaskEnum) {
	inherits(SkyCondition, _BitmaskEnum);
  ...
  */
	function SkyCondition(name, bitNumber) {
		classCallCheck(this, SkyCondition);

		var _this = possibleConstructorReturn(this, (SkyCondition.__proto__ || Object.getPrototypeOf(SkyCondition)).call(this, name, bitNumber));
...
var Environment = function (_Configuration) {
  ...
  */
	function Environment(config) {
		...
		return possibleConstructorReturn(this, (Environment.__proto__ || Object.getPrototypeOf(Environment)).call(this, normalizedConfig(config)));
	}
...
var NodeDatumUrlHelperMixin = function NodeDatumUrlHelperMixin(superclass) {
   ...
   */
     ...
     */
				...
				key: 'datumReadingUrl',
				value: function datumReadingUrl(datumFilter, readingType, tolerance) {
...
var UserDatumAuxiliaryUrlHelper = function (_UserDatumAuxiliaryUr) {
	inherits(UserDatumAuxiliaryUrlHelper, _UserDatumAuxiliaryUr);

	function UserDatumAuxiliaryUrlHelper() {
		classCallCheck(this, UserDatumAuxiliaryUrlHelper);
		return possibleConstructorReturn(this, (UserDatumAuxiliaryUrlHelper.__proto__ || Object.getPrototypeOf(UserDatumAuxiliaryUrlHelper)).apply(this, arguments));
	}
...
var UserMetadataUrlHelper = function (_UserMetadataUrlHelpe) {
    inherits(UserMetadataUrlHelper, _UserMetadataUrlHelpe);

    function UserMetadataUrlHelper() {
        classCallCheck(this, UserMetadataUrlHelper);
        return possibleConstructorReturn(this, (UserMetadataUrlHelper.__proto__ || Object.getPrototypeOf(UserMetadataUrlHelper)).apply(this, arguments));
    }
...
export { array as arrayData, nest$1 as nestData, Aggregations, Aggregation, AuthTokenStatuses, AuthTokenStatus, AuthTokenTypes, AuthTokenType, CombiningTypes, CombiningType, DatumAuxiliaryTypes, DatumAuxiliaryType, DatumFilter, DatumReadingTypes, DatumReadingType, DeviceOperatingStates, DeviceOperatingState, GeneralMetadata, stringMapToObject, objectToStringMap, InstructionStates, InstructionState, Location, LocationPrecisions, LocationPrecision, Pagination, SecurityPolicy, SecurityPolicyBuilder, SkyConditions, SkyCondition, SortDescriptor, timestampFormat, dateTimeFormat, dateTimeUrlFormat, dateFormat, timestampParse, dateTimeParse, dateParser, iso8601Date, seasonForDate, isoParse as dateTimeUrlParse, isoParse as dateParse, displayScaleForValue, displayUnitsForScale, AuthTokenUrlHelperMixin, AuthorizationV2Builder, Environment, HttpHeaders, HttpContentType, HttpMethod, LocationDatumMetadataUrlHelperMixin, LocationDatumMetadataUrlHelper, LocationDatumUrlHelperMixin, LocationDatumUrlHelper, LocationUrlHelperMixin, NodeDatumMetadataUrlHelperMixin, NodeDatumMetadataUrlHelper, NodeDatumUrlHelperMixin, NodeDatumUrlHelper, NodeInstructionUrlHelperMixin, NodeInstructionUrlHelper, instructionParameter, NodeMetadataUrlHelperMixin, NodeMetadataUrlHelper, NodeUrlHelperMixin, QueryUrlHelperMixin, SolarQueryDefaultPath, SolarQueryPathKey, SolarQueryApiPathV1, SolarQueryPublicPathKey, UserAuthTokenUrlHelperMixin, UserAuthTokenUrlHelper, UserDatumAuxiliaryUrlHelperMixin, UserDatumAuxiliaryUrlHelper, UserUrlHelperMixin, SolarUserDefaultPath, SolarUserPathKey, SolarUserApiPathV1, UserMetadataUrlHelperMixin, UserMetadataUrlHelper, UrlHelper, urlQuery, BitmaskEnum, ComparableEnum, Configuration, date as dateUtils, Enum, Logger, logLevels, MultiMap, PropMap };
