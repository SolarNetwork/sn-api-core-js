// https://github.com/SolarNetwork/sn-api-core-js Version 1.0.1-dev.0. Copyright 2023 SolarNetwork Foundation.
import { max, ascending, sum } from 'd3-array';
import { nest as nest$1 } from 'd3-collection';
...
export { isoParse as dateParse, isoParse as dateTimeUrlParse } from 'd3-time-format';
...
var Enum = /*#__PURE__*/function () {
  ...
  _createClass(Enum, [{
    ...
    value: function namesFor(set) {
      var result = [];
      if (set) {
        var _iterator = _createForOfIteratorHelper$8(set),
          _step;
        try {
...
var ComparableEnum = /*#__PURE__*/function (_Enum) {
  ...
  var _super = _createSuper$y(ComparableEnum);
  /**
   * Constructor.
   *
   * @param {string} name the name
  ...
  _createClass(ComparableEnum, [{
    ...
    value: function minimumEnumSet(minEnum, cache) {
      ...
      result = new Set();
      var _iterator = _createForOfIteratorHelper$7(minEnum.constructor.enumValues()),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var agg = _step.value;
...
var Aggregation = /*#__PURE__*/function (_ComparableEnum) {
  ...
  var _super = _createSuper$x(Aggregation);
  /**
   * Constructor.
   *
 ...
 */
var localDateTimeUrlFormat = timeFormat("%Y-%m-%dT%H:%M");
...
function datumDate(d) {
  ...
  if (d.date) {
    ...
    return timestampParse(d.created) || isoParse(d.created);
  }
}
...
function normalizeNestedStackDataByDate(layerData, fillTemplate, fillFn) {
  ...
  if (jMax > 0) {
    while (i < max(layerData.map(function (e) {
...
function groupedBySourceMetricDataArray(data, metricName, sourceIdMap, aggFn) {
  ...
  var rollupFn = typeof aggFn === "function" ? aggFn : sum;
  var layerData = nest$1()
...
var AuthTokenStatus = /*#__PURE__*/function (_Enum) {
  ...
  var _super = _createSuper$w(AuthTokenStatus);
  /**
   * Constructor.
   *
   * @param {string} name the name
...
var AuthTokenType = /*#__PURE__*/function (_Enum) {
  ...
  var _super = _createSuper$v(AuthTokenType);
  /**
   * Constructor.
   *
   * @param {string} name the name
...
var CombiningType = /*#__PURE__*/function (_Enum) {
  ...
  var _super = _createSuper$u(CombiningType);
  /**
   * Constructor.
   *
...
var DatumAuxiliaryType = /*#__PURE__*/function (_Enum) {
  ...
  var _super = _createSuper$t(DatumAuxiliaryType);
  /**
   * Constructor.
   *
   * @param {string} name the unique name for this type
...
var Location = /*#__PURE__*/function (_PropMap) {
  ...
  var _super = _createSuper$s(Location);
  /**
   * Constructor.
   *
...
var AccumulatingPropertyNamesKey = "accumulatingPropertyNames";
var AggregationKey = "aggregation";
var CombiningTypeKey = "combiningType";
var DataPathKey = "dataPath";
var EndDateKey = "endDate";
var InstantaneousPropertyNamesKey = "instantaneousPropertyNames";
var LocalEndDateKey = "localEndDate";
var LocalStartDateKey = "localStartDate";
...
var PropertyNamesKey = "propertyNames";
var QueryKey = "query";
var SourceIdMapsKey = "sourceIdMaps";
var SourceIdsKey$2 = "sourceIds";
var StartDateKey = "startDate";
var StatusPropertyNamesKey = "statusPropertyNames";
var StreamIdsKey = "streamIds";
var TagsKey$1 = "tags";
var UserIdsKey$2 = "userIds";
...
function idMapQueryParameterValue(map) {
  ...
  var result = [];
  var _iterator = _createForOfIteratorHelper$6(map),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var e = _step.value;
...
var DatumFilter = /*#__PURE__*/function (_PropMap) {
  ...
  var _super = _createSuper$r(DatumFilter);
  /**
   * Constructor.
  ...
  _createClass(DatumFilter, [{
    ...
    set: function set(nodeIds) {
      this.prop(NodeIdsKey$1, Array.isArray(nodeIds) ? nodeIds : null);
    }
    ...
    set: function set(locationIds) {
      this.prop(LocationIdsKey$1, Array.isArray(locationIds) ? locationIds : null);
    }
    ...
    set: function set(sourceIds) {
      this.prop(SourceIdsKey$2, Array.isArray(sourceIds) ? sourceIds : null);
    }
    ...
    set: function set(userIds) {
      this.prop(UserIdsKey$2, Array.isArray(userIds) ? userIds : null);
    }
    ...
    set: function set(val) {
      this.prop(TagsKey$1, Array.isArray(val) ? val : null);
    }
    ...
    get: function get() {
      var names = this.instantaneousPropertyNames;
      return Array.isArray(names) && names.length > 0 ? names[0] : null;
    },
    set: function set(name) {
      if (name) {
    ...
    get: function get() {
      var names = this.accumulatingPropertyNames;
      return Array.isArray(names) && names.length > 0 ? names[0] : null;
    },
    set: function set(name) {
      if (name) {
    ...
    get: function get() {
      var names = this.statusPropertyNames;
      return Array.isArray(names) && names.length > 0 ? names[0] : null;
    },
    set: function set(name) {
      if (name) {
...
function datumFilterUriEncodingPropertyMapper(key, value) {
  if (key === NodeIdsKey$1 || key === LocationIdsKey$1 || key === SourceIdsKey$2 || key === UserIdsKey$2 || key === PropertyNamesKey || key === InstantaneousPropertyNamesKey || key === AccumulatingPropertyNamesKey || key === StatusPropertyNamesKey) {
...
var datumFilter = /*#__PURE__*/Object.freeze({
	__proto__: null,
 ...
 */
var KeyedEnum = /*#__PURE__*/function (_Enum) {
  _inherits(KeyedEnum, _Enum);
  var _super = _createSuper$q(KeyedEnum);
  /**
   * Constructor.
   *
   * @param {string} name the unique name for this type
   ...
   */
  function KeyedEnum(name, key) {
    var _this;
    _classCallCheck(this, KeyedEnum);
    _this = _super.call(this, name);
    _this._key = key;
    if (_this.constructor === KeyedEnum) {
      Object.freeze(_assertThisInitialized(_this));
    }
    return _this;
  }
 ...
 */
var DatumReadingType = /*#__PURE__*/function (_KeyedEnum) {
  _inherits(DatumReadingType, _KeyedEnum);
  var _super = _createSuper$p(DatumReadingType);
  /**
   * Constructor.
   *
   * @param {string} name the unique name for this type
  ...
  function DatumReadingType(name, key) {
    ...
    _this = _super.call(this, name, key);
   ...
   * @inheritdoc
   */
  _createClass(DatumReadingType, null, [{
    key: "enumValues",
    value: function enumValues() {
 ...
 */
var DatumSamplesType = /*#__PURE__*/function (_KeyedEnum) {
  _inherits(DatumSamplesType, _KeyedEnum);
  var _super = _createSuper$o(DatumSamplesType);
  /**
   * Constructor.
   *
   * @param {string} name the unique name for this type
   * @param {string} key the key value associated with this type
   */
  function DatumSamplesType(name, key) {
    var _this;
    _classCallCheck(this, DatumSamplesType);
    _this = _super.call(this, name, key);
    if (_this.constructor === DatumSamplesType) {
      Object.freeze(_assertThisInitialized(_this));
    }
    return _this;
  }
   ...
   * @inheritdoc
   */
  _createClass(DatumSamplesType, null, [{
    key: "enumValues",
    value: function enumValues() {
...
var DatumSamplesTypeValues = Object.freeze([new DatumSamplesType("Instantaneous", "i"), new DatumSamplesType("Accumulating", "a"), new DatumSamplesType("Status", "s"), new DatumSamplesType("Tag", "t")]);
 ...
 */
var DatumSamplesTypes = DatumSamplesType.enumsValue(DatumSamplesTypeValues);
 ...
 */
var DatumStreamType = /*#__PURE__*/function (_KeydEnum) {
  _inherits(DatumStreamType, _KeydEnum);
  var _super = _createSuper$n(DatumStreamType);
  /**
   * Constructor.
   *
   * @param {string} name the unique name for this type
   * @param {string} key the key value associated with this type
   */
  function DatumStreamType(name, key) {
    _classCallCheck(this, DatumStreamType);
    return _super.call(this, name, key);
  }
   ...
   * @inheritdoc
   */
  _createClass(DatumStreamType, null, [{
    key: "enumValues",
    value: function enumValues() {
      return DatumStreamTypeValues;
    }
  }]);
  return DatumStreamType;
}(KeyedEnum);
var DatumStreamTypeValues = Object.freeze([new DatumStreamType("Node", "n"), new DatumStreamType("Location", "l")]);
 ...
 * @alias module:domain~DatumStreamType
 */
var DatumStreamTypes = DatumStreamType.enumsValue(DatumStreamTypeValues);
 ...
 */
var DatumStreamMetadata = /*#__PURE__*/function () {
  /**
   * Constructor.
   ...
   */
  function DatumStreamMetadata(streamId, zone, kind, objectId, sourceId, iNames, aNames, sNames) {
    _classCallCheck(this, DatumStreamMetadata);
   ...
   */
  _createClass(DatumStreamMetadata, [{
    key: "streamId",
    get:
    /**
    ...
    key: "propertyNames",
    get: function get() {
      var len = this.propertyNamesLength;
      if (len < 1) {
        return null;
      }
      var names = [];
    ...
    value: function propertyNamesForType(samplesType) {
    ...
    key: "nodeMetadata",
    value: function nodeMetadata(streamId, zone, nodeId, sourceId, iNames, aNames, sNames) {
    ...
    value: function locationMetadata(streamId, zone, locationId, sourceId, iNames, aNames, sNames) {
    ...
    key: "fromJsonObject",
    value: function fromJsonObject(obj) {
      var kind, i, a, s;
      if (obj) {
...
var BitmaskEnum = /*#__PURE__*/function (_Enum) {
  ...
  var _super = _createSuper$m(BitmaskEnum);
  /**
   * Constructor.
   *
   * @param {string} name the name
  ...
  _createClass(BitmaskEnum, [{
    ...
    value: function enumForBitNumber(bitNumber, values) {
      var _iterator = _createForOfIteratorHelper$5(values),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var c = _step.value;
    ...
    value: function bitmaskValue(maskables) {
      var mask = 0;
      if (maskables != null) {
        var _iterator2 = _createForOfIteratorHelper$5(maskables),
          _step2;
        try {
    ...
    value: function setForBitmask(mask, values) {
      ...
      var set = new Set();
      var _iterator3 = _createForOfIteratorHelper$5(values),
        _step3;
      try {
...
var DeviceOperatingState = /*#__PURE__*/function (_BitmaskEnum) {
  ...
  var _super = _createSuper$l(DeviceOperatingState);
  /**
   * Constructor.
   *
   * @param {string} name the name
...
var InstructionState = /*#__PURE__*/function (_Enum) {
  ...
  var _super = _createSuper$k(InstructionState);
  /**
   * Constructor.
   *
   * @param {string} name the name
...
var LocationPrecision = /*#__PURE__*/function (_ComparableEnum) {
  ...
  var _super = _createSuper$j(LocationPrecision);
  /**
   * Constructor.
   *
   * @param {string} name the unique name for this precision
...
function mergedSets(set1, set2) {
  ...
  if (s1 === null && s2 === null) {
    ...
    var _iterator = _createForOfIteratorHelper$3(s2.values()),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var v = _step.value;
...
var SkyCondition = /*#__PURE__*/function (_BitmaskEnum) {
  ...
  var _super = _createSuper$i(SkyCondition);
  /**
   * Constructor.
   *
   * @param {string} name the name
 ...
 */
var DatumStreamMetadataRegistry = /*#__PURE__*/function () {
  /**
   * Constructor.
   * @param {DatumStreamMetadata[]} [metas] optional list of metadata to start with
   */
  function DatumStreamMetadataRegistry(metas) {
    _classCallCheck(this, DatumStreamMetadataRegistry);
    this._metaList = Array.isArray(metas) ? metas : [];
    this._metaMap = new Map();
    var _iterator = _createForOfIteratorHelper$2(this._metaList),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var e = _step.value;
   ...
   */
  _createClass(DatumStreamMetadataRegistry, [{
    key: "addMetadata",
    value: function addMetadata(meta) {
    ...
    value: function metadataStreamIds() {
    ...
    key: "metadataAt",
    value: function metadataAt(index) {
    ...
    value: function indexOfMetadataStreamId(streamId) {
      var i = 0;
      var _iterator2 = _createForOfIteratorHelper$2(this._metaList),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    ...
    value: function metadataStreamIdsList() {
      return this._metaList.map(function (e) {
        return e.streamId;
      });
    }
    ...
    value: function metadataForStreamId(streamId) {
    ...
    value: function metadataForObjectSource(objectId, sourceId) {
      var _iterator3 = _createForOfIteratorHelper$2(this._metaMap.values()),
        _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
    ...
    value: function toJsonEncoding() {
      var json = "[";
      var _iterator4 = _createForOfIteratorHelper$2(this._metaList),
        _step4;
      try {
    ...
    key: "fromJsonObject",
    value: function fromJsonObject(data) {
      if (Array.isArray(data)) {
        var reg = new DatumStreamMetadataRegistry();
        var _iterator5 = _createForOfIteratorHelper$2(data),
          _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var e = _step5.value;
            var meta = DatumStreamMetadata.fromJsonObject(e);
            if (meta) {
...
function populateProperties$1(obj, names, values, type, withoutStatistics) {
  ...
  var val, name, valLen;
  for (var i = 0, iMax = Math.min(names.length, values.length); i < iMax; i += 1) {
    val = values[i];
    if (DatumSamplesTypes.Instantaneous === type) {
      if (Array.isArray(val)) {
        name = names[i];
        valLen = val.length;
        if (valLen > 0 && val[0] !== null && !Object.prototype.hasOwnProperty.call(obj, name)) {
          obj[name] = val[0];
 ...
 */
var StreamAggregateDatum = /*#__PURE__*/function () {
  /**
   * Constructor.
   ...
   */
  function StreamAggregateDatum(streamId, ts, iProps, aProps, sProps, tags) {
    _classCallCheck(this, StreamAggregateDatum);
    this.streamId = streamId;
    this.ts = Array.isArray(ts) ? ts.map(function (e) {
   ...
   */
  _createClass(StreamAggregateDatum, [{
    key: "toObject",
    value: function toObject(meta, withoutStatistics) {
      var obj = {
      ...
      populateProperties$1(obj, meta.instantaneousNames, this.iProps, DatumSamplesTypes.Instantaneous, withoutStatistics);
      populateProperties$1(obj, meta.accumulatingNames, this.aProps, DatumSamplesTypes.Accumulating, withoutStatistics);
      populateProperties$1(obj, meta.statusNames, this.sProps, DatumSamplesTypes.Status);
      return obj;
    }
    ...
    key: "toJsonEncoding",
    value: function toJsonEncoding(registry) {
    ...
    key: "toJsonObject",
    value: function toJsonObject(registry) {
      var result = [registry instanceof DatumStreamMetadataRegistry ? registry.indexOfMetadataStreamId(this.streamId) : this.streamId, this.ts.map(function (e) {
        return e ? e.getTime() : null;
      })];
      pushProperties$1(result, this.iProps);
      pushProperties$1(result, this.aProps);
      pushProperties$1(result, this.sProps);
      pushProperties$1(result, this.tags);
      return result;
    }
    ...
    key: "fromJsonEncoding",
    value: function fromJsonEncoding(json, meta) {
    ...
    key: "fromJsonObject",
    value: function fromJsonObject(data, meta) {
      var i, len, m, iProps, aProps, sProps, tags;
...
function populateProperties(obj, names, values) {
  ...
  var val, name;
  for (var i = 0, len = Math.min(names.length, values.length); i < len; i += 1) {
    val = values[i];
    if (val !== undefined && val !== null) {
      name = names[i];
      if (!Object.prototype.hasOwnProperty.call(obj, name)) {
 ...
 */
var StreamDatum = /*#__PURE__*/function () {
  /**
   * Constructor.
   * @param {string} streamId the datum stream ID
   ...
   * @param {Set<String>|Array<String>} [tags] the tag values
   */
  function StreamDatum(streamId, ts, iProps, aProps, sProps, tags) {
    _classCallCheck(this, StreamDatum);
    this.streamId = streamId;
   ...
   */
  _createClass(StreamDatum, [{
    key: "propertyValuesForType",
    value: function propertyValuesForType(samplesType) {
      if (DatumSamplesTypes.Instantaneous.equals(samplesType)) {
        return this.iProps;
      } else if (DatumSamplesTypes.Accumulating.equals(samplesType)) {
        return this.aProps;
    ...
    key: "toJsonObject",
    value: function toJsonObject(registry) {
      var result = [registry instanceof DatumStreamMetadataRegistry ? registry.indexOfMetadataStreamId(this.streamId) : this.streamId, this.ts.getTime()];
    ...
    key: "fromJsonObject",
    value: function fromJsonObject(data, meta) {
      var i, len, m, ts, iProps, aProps, sProps, tags;
      if (Array.isArray(data) && data.length > 1) {
        if (typeof data[0] === "string") {
          // treat as an embedded stream ID stream datum
          m = meta instanceof DatumStreamMetadata ? meta : meta.metadataForStreamId(data[0]);
 ...
 */
var StreamDatumMetadataMixin = function StreamDatumMetadataMixin(superclass) {
  return (
    /*#__PURE__*/
    /**
    ...
    function (_superclass) {
      ...
      function _class() {
        ...
        if (args.length > 0 && args[args.length - 1] instanceof DatumStreamMetadata) {
          _this._meta = args[args.length - 1];
        }
        Object.freeze(_assertThisInitialized(_this));
        return _this;
      }
      ...
      _createClass(_class, [{
        ...
        key: "toObject",
        value: function toObject(withoutStatistics) {
          return _get(_getPrototypeOf(_class.prototype), "toObject", this).call(this, this._meta, withoutStatistics);
        }
      }]);
      return _class;
    }(superclass)
 ...
 */
var AggregateDatum = /*#__PURE__*/function (_StreamDatumMetadataM) {
  _inherits(AggregateDatum, _StreamDatumMetadataM);
  var _super2 = _createSuper$h(AggregateDatum);
  function AggregateDatum() {
    _classCallCheck(this, AggregateDatum);
    return _super2.apply(this, arguments);
  }
  return _createClass(AggregateDatum);
}(StreamDatumMetadataMixin(StreamAggregateDatum));
/**
 ...
 */
var Datum = /*#__PURE__*/function (_StreamDatumMetadataM2) {
  _inherits(Datum, _StreamDatumMetadataM2);
  var _super3 = _createSuper$h(Datum);
  function Datum() {
    _classCallCheck(this, Datum);
    return _super3.apply(this, arguments);
  }
  return _createClass(Datum);
 ...
 */
var UserMetadataFilter = /*#__PURE__*/function (_PropMap) {
  _inherits(UserMetadataFilter, _PropMap);
  var _super = _createSuper$g(UserMetadataFilter);
  /**
   * Constructor.
   * @param {object} [props] initial property values
   */
  function UserMetadataFilter(props) {
    _classCallCheck(this, UserMetadataFilter);
    return _super.call(this, props);
  }
   ...
   * @type {number}
   */
  _createClass(UserMetadataFilter, [{
    key: "userId",
    get: function get() {
      var userIds = this.userIds;
      return Array.isArray(userIds) && userIds.length > 0 ? userIds[0] : null;
    ...
    set: function set(userIds) {
      this.prop(UserIdsKey$1, Array.isArray(userIds) ? userIds : null);
    }
    ...
    key: "toUriEncoding",
    value: function toUriEncoding(propertyName, callbackFn) {
      return _get(_getPrototypeOf(UserMetadataFilter.prototype), "toUriEncoding", this).call(this, propertyName, callbackFn || userMetadataFilterUriEncodingPropertyMapper);
    }
  }]);
...
var userMetadataFilter = /*#__PURE__*/Object.freeze({
	__proto__: null,
	TagsKey: TagsKey,
...
var AuthTokenUrlHelperMixin = function AuthTokenUrlHelperMixin(superclass) {
  return (
    ...
    function (_superclass) {
      _inherits(_class, _superclass);
      var _super = _createSuper$f(_class);
      function _class() {
        _classCallCheck(this, _class);
...
var Environment = /*#__PURE__*/function (_Configuration) {
  ...
  var _super = _createSuper$e(Environment);
  /**
   * Constructor.
   *
...
var HttpHeaders = /*#__PURE__*/function (_MultiMap) {
  ...
  var _super = _createSuper$d(HttpHeaders);
...
var QueryUrlHelperMixin = function QueryUrlHelperMixin(superclass) {
  return (
    ...
    function (_superclass) {
      _inherits(_class, _superclass);
      var _super = _createSuper$b(_class);
      function _class() {
        _classCallCheck(this, _class);
        return _super.apply(this, arguments);
      }
...
var LocationDatumMetadataUrlHelper = /*#__PURE__*/function (_LocationDatumMetadat) {
  ...
  var _super2 = _createSuper$a(LocationDatumMetadataUrlHelper);
  function LocationDatumMetadataUrlHelper() {
    _classCallCheck(this, LocationDatumMetadataUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(LocationDatumMetadataUrlHelper);
...
var LocationDatumUrlHelper = /*#__PURE__*/function (_LocationDatumUrlHelp) {
  ...
  var _super2 = _createSuper$9(LocationDatumUrlHelper);
  function LocationDatumUrlHelper() {
    _classCallCheck(this, LocationDatumUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(LocationDatumUrlHelper);
  ...
  return (
    ...
    function (_superclass) {
      ...
      _createClass(_class, [{
        ...
        key: "findSourcesUrl",
        value: function findSourcesUrl(datumFilter) {
          var filter = datumFilter ? new DatumFilter(datumFilter) : this.datumFilter();
          var result = this.baseUrl() + "/nodes/sources";
...
var NodeDatumMetadataUrlHelperMixin = function NodeDatumMetadataUrlHelperMixin(superclass) {
  return (
    ...
    function (_superclass) {
      _inherits(_class, _superclass);
      var _super = _createSuper$7(_class);
      function _class() {
        _classCallCheck(this, _class);
        return _super.apply(this, arguments);
      }
...
var NodeDatumMetadataUrlHelper = /*#__PURE__*/function (_NodeDatumMetadataUrl) {
  ...
  var _super2 = _createSuper$7(NodeDatumMetadataUrlHelper);
  function NodeDatumMetadataUrlHelper() {
    _classCallCheck(this, NodeDatumMetadataUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(NodeDatumMetadataUrlHelper);
  ...
  return (
    ...
    function (_superclass) {
      ...
      _createClass(_class, [{
        ...
        key: "streamDatumUrl",
        value: function streamDatumUrl(datumFilter, sorts, pagination) {
          var result = this.baseUrl() + "/datum/stream/datum";
          var filter = datumFilter || this.datumFilter();
          var params = filter.toUriEncodingWithSorting(sorts, pagination);
          if (params.length > 0) {
            result += "?" + params;
        ...
        value: function streamReadingUrl(datumFilter, readingType, tolerance, sorts, pagination) {
          var result = this.baseUrl() + "/datum/stream/reading";
          var filter = new DatumFilter(datumFilter) || this.datumFilter();
          filter.prop("readingType", readingType.name);
          if (tolerance) {
            filter.prop("tolerance", tolerance);
...
var NodeDatumUrlHelper = /*#__PURE__*/function (_NodeDatumUrlHelperMi) {
  ...
  var _super2 = _createSuper$6(NodeDatumUrlHelper);
  function NodeDatumUrlHelper() {
    _classCallCheck(this, NodeDatumUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(NodeDatumUrlHelper);
...
var NodeInstructionUrlHelper = /*#__PURE__*/function (_NodeInstructionUrlHe) {
  ...
  var _super2 = _createSuper$4(NodeInstructionUrlHelper);
  function NodeInstructionUrlHelper() {
    _classCallCheck(this, NodeInstructionUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(NodeInstructionUrlHelper);
...
var NodeMetadataUrlHelper = /*#__PURE__*/function (_NodeMetadataUrlHelpe) {
  ...
  var _super2 = _createSuper$3(NodeMetadataUrlHelper);
  function NodeMetadataUrlHelper() {
    _classCallCheck(this, NodeMetadataUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(NodeMetadataUrlHelper);
...
var UserAuthTokenUrlHelper = /*#__PURE__*/function (_UserAuthTokenUrlHelp) {
  ...
  var _super2 = _createSuper$2(UserAuthTokenUrlHelper);
  function UserAuthTokenUrlHelper() {
    _classCallCheck(this, UserAuthTokenUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(UserAuthTokenUrlHelper);
...
var UserDatumAuxiliaryUrlHelper = /*#__PURE__*/function (_UserDatumAuxiliaryUr) {
  ...
  var _super2 = _createSuper$1(UserDatumAuxiliaryUrlHelper);
  function UserDatumAuxiliaryUrlHelper() {
    _classCallCheck(this, UserDatumAuxiliaryUrlHelper);
    return _super2.apply(this, arguments);
  }
  return _createClass(UserDatumAuxiliaryUrlHelper);
...
var UserMetadataUrlHelper = /*#__PURE__*/function (_UserMetadataUrlHelpe) {
  ...
  return _createClass(UserMetadataUrlHelper);
...
function datumForStreamData(data, meta) {
  ...
  return Array.isArray(data[1]) ? AggregateDatum.fromJsonObject(data, meta) : Datum.fromJsonObject(data, meta);
}
 ...
 */
function streamDatumForData(data, meta) {
  if (typeof data === "string") {
    data = JSON.parse(data);
  }
  if (!Array.isArray(data) || data.length < 2) {
  ...
  return Array.isArray(data[1]) ? StreamAggregateDatum.fromJsonObject(data, meta) : StreamDatum.fromJsonObject(data, meta);
}
...
export { AggregateDatum, Aggregation, Aggregations, AuthTokenStatus, AuthTokenStatuses, AuthTokenType, AuthTokenTypes, AuthTokenUrlHelperMixin, AuthorizationV2Builder, BitmaskEnum, CombiningType, CombiningTypes, ComparableEnum, Configuration, Datum, DatumAuxiliaryType, DatumAuxiliaryTypes, DatumFilter, datumFilter as DatumFilterKeys, DatumReadingType, DatumReadingTypes, DatumSamplesType, DatumSamplesTypes, DatumStreamMetadata, DatumStreamMetadataRegistry, DatumStreamType, DatumStreamTypes, DeviceOperatingState, DeviceOperatingStates, Enum, Environment, GeneralMetadata, HttpContentType, HttpHeaders, HttpMethod, InstructionState, InstructionStates, KeyedEnum, Location, LocationDatumMetadataUrlHelper, LocationDatumMetadataUrlHelperMixin, LocationDatumUrlHelper, LocationDatumUrlHelperMixin, datumFilter as LocationKeys, LocationPrecision, LocationPrecisions, LocationUrlHelperMixin, Logger, MultiMap, NodeDatumMetadataUrlHelper, NodeDatumMetadataUrlHelperMixin, NodeDatumUrlHelper, NodeDatumUrlHelperMixin, NodeInstructionUrlHelper, NodeInstructionUrlHelperMixin, NodeMetadataUrlHelper, NodeMetadataUrlHelperMixin, NodeUrlHelperMixin, Pagination, PropMap, QueryUrlHelperMixin, SecurityPolicy, SecurityPolicyBuilder, SkyCondition, SkyConditions, SolarQueryApiPathV1, SolarQueryDefaultPath, SolarQueryPathKey, SolarQueryPublicPathKey, SolarUserApiPathV1, SolarUserDefaultPath, SolarUserPathKey, SortDescriptor, StreamAggregateDatum, StreamDatum, StreamDatumMetadataMixin, UrlHelper, UserAuthTokenUrlHelper, UserAuthTokenUrlHelperMixin, UserDatumAuxiliaryUrlHelper, UserDatumAuxiliaryUrlHelperMixin, UserMetadataFilter, userMetadataFilter as UserMetadataFilterKeys, UserMetadataUrlHelper, UserMetadataUrlHelperMixin, UserUrlHelperMixin, array as arrayData, dateFormat, dateParser, dateTimeFormat, dateTimeParse, dateTimeUrlFormat, date as dateUtils, datumForStreamData, displayScaleForValue, displayUnitsForScale, instructionParameter, iso8601Date, localDateTimeUrlFormat, logLevels, nest as nestData, objectToStringMap, seasonForDate, streamDatumForData, streamDatumUtils, stringMapToObject, timestampFormat, timestampParse, urlQuery };
