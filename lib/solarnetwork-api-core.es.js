// https://github.com/SolarNetwork/sn-api-core-js Version 0.21.0. Copyright 2020 SolarNetwork Foundation.
...
function (_Enum) {
  ...
  function ComparableEnum(name, value) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ComparableEnum).call(this, name));
    _this._value = value;
...
function (_ComparableEnum) {
  ...
  function Aggregation(name, level) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Aggregation).call(this, name, level));
...
function (_Enum) {
  ...
  function AuthTokenStatus(name) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AuthTokenStatus).call(this, name));
...
function (_Enum) {
  ...
  function AuthTokenType(name) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AuthTokenType).call(this, name));
...
function (_Enum) {
  ...
  function CombiningType(name) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CombiningType).call(this, name));
...
var CombiningTypeValues = Object.freeze([new CombiningType("Average"), new CombiningType("Sum")]);
/**
...
function (_Enum) {
  ...
  function DatumAuxiliaryType(name) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DatumAuxiliaryType).call(this, name));
...
function (_PropMap) {
  ...
  function Location(loc) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Location).call(this, loc));
  }
  /**
...
function (_PropMap) {
  ...
  function DatumFilter(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DatumFilter).call(this, props));
  }
  /**
   * A node ID.
   *
...
function (_Enum) {
  ...
  function DatumReadingType(name, key) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DatumReadingType).call(this, name));
    _this._key = key;
...
function (_Enum) {
  ...
  function BitmaskEnum(name, bitNumber) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BitmaskEnum).call(this, name));
  ...
  _createClass(BitmaskEnum, [{
    ...
    value: function bitmaskValue(maskables) {
      ...
      if (maskables != null) {
        ...
        try {
          for (var _iterator2 = maskables[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var c = _step2.value;
...
var DeviceOperatingState =
/*#__PURE__*/
function (_BitmaskEnum) {
  ...
  function DeviceOperatingState(name, bitNumber) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DeviceOperatingState).call(this, name, bitNumber));
...
function (_Enum) {
  ...
  function InstructionState(name) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(InstructionState).call(this, name));
...
function (_ComparableEnum) {
  ...
  function LocationPrecision(name, precision) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(LocationPrecision).call(this, name, precision));
...
function (_BitmaskEnum) {
  ...
  function SkyCondition(name, bitNumber) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SkyCondition).call(this, name, bitNumber));
  ...
  return (
    ...
    function (_superclass) {
      ...
      _createClass(_class, [{
         ...
         */
        value: function refreshTokenV2Url(date) {
...
function (_Configuration) {
  ...
  function Environment(config) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Environment).call(this, normalizedConfig(config)));
  }
  /**
...
function (_MultiMap) {
  ...
  function HttpHeaders() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(HttpHeaders).call(this));
  }
...
function () {
  ...
  _createClass(AuthorizationV2Builder, [{
    ...
    value: function reset() {
      ...
      return this.headers(new HttpHeaders()).queryParams(new MultiMap()).signedHttpHeaders([]).method(HttpMethod.GET).host(host).path("/").date(new Date());
    }
    /**
...
var LocationDatumMetadataUrlHelper =
/*#__PURE__*/
function (_LocationDatumMetadat) {
  ...
  function LocationDatumMetadataUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(LocationDatumMetadataUrlHelper).apply(this, arguments));
  }
...
var LocationDatumUrlHelper =
/*#__PURE__*/
function (_LocationDatumUrlHelp) {
  ...
  function LocationDatumUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(LocationDatumUrlHelper).apply(this, arguments));
  }
...
var NodeDatumMetadataUrlHelper =
/*#__PURE__*/
function (_NodeDatumMetadataUrl) {
  ...
  function NodeDatumMetadataUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(NodeDatumMetadataUrlHelper).apply(this, arguments));
  }
...
var NodeDatumUrlHelper =
/*#__PURE__*/
function (_NodeDatumUrlHelperMi) {
  _inherits(NodeDatumUrlHelper, _NodeDatumUrlHelperMi);

  function NodeDatumUrlHelper() {
    _classCallCheck(this, NodeDatumUrlHelper);

    return _possibleConstructorReturn(this, _getPrototypeOf(NodeDatumUrlHelper).apply(this, arguments));
  }
...
function (_NodeInstructionUrlHe) {
  ...
  function NodeInstructionUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(NodeInstructionUrlHelper).apply(this, arguments));
  }
...
var NodeMetadataUrlHelper =
/*#__PURE__*/
function (_NodeMetadataUrlHelpe) {
  ...
  function NodeMetadataUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(NodeMetadataUrlHelper).apply(this, arguments));
  }
...
var UserAuthTokenUrlHelper =
/*#__PURE__*/
function (_UserAuthTokenUrlHelp) {
  ...
  function UserAuthTokenUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UserAuthTokenUrlHelper).apply(this, arguments));
  }
...
var UserDatumAuxiliaryUrlHelper =
/*#__PURE__*/
function (_UserDatumAuxiliaryUr) {
  ...
  function UserDatumAuxiliaryUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UserDatumAuxiliaryUrlHelper).apply(this, arguments));
  }
  ...
  return (
    ...
    function (_superclass) {
      ...
      _createClass(_class, [{
         ...
         * @returns {string} the URL
         */
        value: function findUserMetadataUrl(filter) {
          var result = this.baseUrl() + "/users/meta";
...
var UserMetadataUrlHelper =
/*#__PURE__*/
function (_UserMetadataUrlHelpe) {
  ...
  function UserMetadataUrlHelper() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(UserMetadataUrlHelper).apply(this, arguments));
  }
...
export { Aggregation, Aggregations, AuthTokenStatus, AuthTokenStatuses, AuthTokenType, AuthTokenTypes, AuthTokenUrlHelperMixin, AuthorizationV2Builder, BitmaskEnum, CombiningType, CombiningTypes, ComparableEnum, Configuration, DatumAuxiliaryType, DatumAuxiliaryTypes, DatumFilter, DatumReadingType, DatumReadingTypes, DeviceOperatingState, DeviceOperatingStates, Enum, Environment, GeneralMetadata, HttpContentType, HttpHeaders, HttpMethod, InstructionState, InstructionStates, Location, LocationDatumMetadataUrlHelper, LocationDatumMetadataUrlHelperMixin, LocationDatumUrlHelper, LocationDatumUrlHelperMixin, LocationPrecision, LocationPrecisions, LocationUrlHelperMixin, Logger, MultiMap, NodeDatumMetadataUrlHelper, NodeDatumMetadataUrlHelperMixin, NodeDatumUrlHelper, NodeDatumUrlHelperMixin, NodeInstructionUrlHelper, NodeInstructionUrlHelperMixin, NodeMetadataUrlHelper, NodeMetadataUrlHelperMixin, NodeUrlHelperMixin, Pagination, PropMap, QueryUrlHelperMixin, SecurityPolicy, SecurityPolicyBuilder, SkyCondition, SkyConditions, SolarQueryApiPathV1, SolarQueryDefaultPath, SolarQueryPathKey, SolarQueryPublicPathKey, SolarUserApiPathV1, SolarUserDefaultPath, SolarUserPathKey, SortDescriptor, UrlHelper, UserAuthTokenUrlHelper, UserAuthTokenUrlHelperMixin, UserDatumAuxiliaryUrlHelper, UserDatumAuxiliaryUrlHelperMixin, UserMetadataUrlHelper, UserMetadataUrlHelperMixin, UserUrlHelperMixin, array as arrayData, dateFormat, dateParser, dateTimeFormat, dateTimeParse, dateTimeUrlFormat, date as dateUtils, displayScaleForValue, displayUnitsForScale, instructionParameter, iso8601Date, logLevels, nest as nestData, objectToStringMap, seasonForDate, stringMapToObject, timestampFormat, timestampParse, urlQuery };
