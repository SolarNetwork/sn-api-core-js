	  ...
	  _createClass(AuthorizationV2Builder, [{
	    ...
	    value: function contentSHA256(digest) {
	      ...
	      if (typeof digest === "string") {
	        contentDigest = Hex__default["default"].parse(digest);
	      } else {
	    ...
	    value: function computeContentDigest(content) {
	      var digest = SHA256__default["default"](content);
	      this.contentSHA256(digest);
	      this.header("Digest", "sha-256=" + Base64__default["default"].stringify(digest));
	      return this;
	    }
	    /**
	    ...
	    value: function canonicalContentSHA256() {
	      return this.contentDigest ? Hex__default["default"].stringify(this.contentDigest) : AuthorizationV2Builder.EMPTY_STRING_SHA256_HEX;
	    }
	    /**
	    ...
	    value: function computeSigningKey(secretKey) {
	      ...
	      var key = HmacSHA256__default["default"]("snws2_request", HmacSHA256__default["default"](datestring, "SNWS2" + secretKey));
	      return key;
	    }
	    /**
	    ...
	    value: function computeSignatureData(canonicalRequestData) {
	      /*- signature data is like:
	            ...
	            */
	      return "SNWS2-HMAC-SHA256\n" + iso8601Date(this.requestDate, true) + "\n" + Hex__default["default"].stringify(SHA256__default["default"](canonicalRequestData));
	    }
	    /**
	    ...
	    value: function buildWithKey(signingKey) {
	      ...
	      var signature = Hex__default["default"].stringify(HmacSHA256__default["default"](signatureData, signingKey));
