...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-array'), require('d3-collection'), require('d3-time'), require('d3-time-format'), require('crypto-js/enc-base64.js'), require('crypto-js/enc-hex.js'), require('crypto-js/hmac-sha256.js'), require('crypto-js/sha256.js'), require('uri-js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-array', 'd3-collection', 'd3-time', 'd3-time-format', 'crypto-js/enc-base64.js', 'crypto-js/enc-hex.js', 'crypto-js/hmac-sha256.js', 'crypto-js/sha256.js', 'uri-js'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.sn = {}, global.d3, global.d3, global.d3, global.d3, global.CryptoJS.Base64, global.CryptoJS.Hex, global.CryptoJS.HmacSHA256, global.CryptoJS.SHA256, global.URI));
	 ...
	 */
	var localDateTimeUrlFormat = d3TimeFormat.timeFormat("%Y-%m-%dT%H:%M");
	...
	function groupedBySourceMetricDataArray(data, metricName, sourceIdMap, aggFn) {
	  ...
	  var layerData = d3Collection.nest()
	...
	var KeyedEnum = /*#__PURE__*/function (_Enum) {
	  ...
	  var _super = _createSuper(KeyedEnum);
	  /**
	   * Constructor.
	   *
	   * @param {string} name the unique name for this type
	...
	var DatumSamplesType = /*#__PURE__*/function (_KeyedEnum) {
	  ...
	  var _super = _createSuper(DatumSamplesType);
	  /**
	   * Constructor.
	   *
	   * @param {string} name the unique name for this type
	...
	var DatumStreamType = /*#__PURE__*/function (_KeydEnum) {
	  ...
	  var _super = _createSuper(DatumStreamType);
	  /**
	   * Constructor.
	   *
	   * @param {string} name the unique name for this type
	...
	var DatumStreamMetadataRegistry = /*#__PURE__*/function () {
	  ...
	  function DatumStreamMetadataRegistry(metas) {
	    ...
	    var _iterator = _createForOfIteratorHelper(this._metaList),
	      _step;
	    try {
	      for (_iterator.s(); !(_step = _iterator.n()).done;) {
	        var e = _step.value;
	  ...
	  _createClass(DatumStreamMetadataRegistry, [{
	    ...
	    value: function indexOfMetadataStreamId(streamId) {
	      var i = 0;
	      var _iterator2 = _createForOfIteratorHelper(this._metaList),
	        _step2;
	      try {
	        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
	    ...
	    value: function metadataForObjectSource(objectId, sourceId) {
	      var _iterator3 = _createForOfIteratorHelper(this._metaMap.values()),
	        _step3;
	      try {
	        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
	    ...
	    value: function toJsonEncoding() {
	      var json = "[";
	      var _iterator4 = _createForOfIteratorHelper(this._metaList),
	        _step4;
	      try {
	...
	var AggregateDatum = /*#__PURE__*/function (_StreamDatumMetadataM) {
	  ...
	  var _super2 = _createSuper(AggregateDatum);
	...
	var Datum = /*#__PURE__*/function (_StreamDatumMetadataM2) {
	  ...
	  var _super3 = _createSuper(Datum);
	  function Datum() {
	...
	var UserMetadataFilter = /*#__PURE__*/function (_PropMap) {
	  ...
	  var _super = _createSuper(UserMetadataFilter);
	  /**
	   * Constructor.
	   * @param {object} [props] initial property values
	   */
	...
	Object.defineProperty(exports, 'dateParse', {
		enumerable: true,
		get: function () { return d3TimeFormat.isoParse; }
	});
	Object.defineProperty(exports, 'dateTimeUrlParse', {
		enumerable: true,
		get: function () { return d3TimeFormat.isoParse; }
	});
	exports.AggregateDatum = AggregateDatum;
	...
	exports.DatumFilterKeys = datumFilter;
	exports.DatumReadingType = DatumReadingType;
	exports.DatumReadingTypes = DatumReadingTypes;
	exports.DatumSamplesType = DatumSamplesType;
	exports.DatumSamplesTypes = DatumSamplesTypes;
	exports.DatumStreamMetadata = DatumStreamMetadata;
	exports.DatumStreamMetadataRegistry = DatumStreamMetadataRegistry;
	exports.DatumStreamType = DatumStreamType;
	exports.DatumStreamTypes = DatumStreamTypes;
	...
	exports.LocationKeys = datumFilter;
	...
	exports.StreamAggregateDatum = StreamAggregateDatum;
	exports.StreamDatum = StreamDatum;
	exports.StreamDatumMetadataMixin = StreamDatumMetadataMixin;
	...
	exports.UserMetadataFilter = UserMetadataFilter;
	exports.UserMetadataFilterKeys = userMetadataFilter;
	...
	exports.datumForStreamData = datumForStreamData;
	...
	exports.localDateTimeUrlFormat = localDateTimeUrlFormat;
	exports.logLevels = logLevels;
	exports.nestData = nest;
	exports.objectToStringMap = objectToStringMap;
	exports.seasonForDate = seasonForDate;
	exports.streamDatumForData = streamDatumForData;
	exports.streamDatumUtils = streamDatumUtils;
