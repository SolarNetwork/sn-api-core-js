...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-time-format'), require('crypto-js/enc-base64'), require('crypto-js/enc-hex'), require('crypto-js/hmac-sha256'), require('crypto-js/sha256'), require('uri-js'), require('d3-time')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-time-format', 'crypto-js/enc-base64', 'crypto-js/enc-hex', 'crypto-js/hmac-sha256', 'crypto-js/sha256', 'uri-js', 'd3-time'], factory) :
	(factory((global.sn = global.sn || {}),global.d3,global.CryptoJS.Base64,global.CryptoJS.Hex,global.CryptoJS.HmacSHA256,global.CryptoJS.SHA256,global.URI,global.d3));
}(this, (function (exports,d3TimeFormat,Base64,Hex,HmacSHA256,SHA256,uriJs,d3Time) { 'use strict';
