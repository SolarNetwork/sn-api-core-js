...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-time-format'), require('crypto-js/enc-hex'), require('crypto-js/hmac-sha256'), require('crypto-js/sha256'), require('uri-js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-time-format', 'crypto-js/enc-hex', 'crypto-js/hmac-sha256', 'crypto-js/sha256', 'uri-js'], factory) :
	(factory((global.sn = global.sn || {}),global.d3,global.CryptoJS.Hex,global.CryptoJS.HmacSHA256,global.CryptoJS.SHA256,global.URI));
}(this, (function (exports,d3TimeFormat,Hex,HmacSHA256,SHA256,uriJs) { 'use strict';
...
exports.DatumMetadataUrlHelperMixin = DatumMetadataUrlHelperMixin;
exports.DatumMetadataUrlHelper = DatumMetadataUrlHelper;
