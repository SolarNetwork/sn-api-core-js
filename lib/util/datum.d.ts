 ...
 */
export declare function datumForStreamData(data: any[] | string, meta: DatumStreamMetadata | DatumStreamMetadataRegistry): StreamedDatum | undefined;
/**
 ...
 */
export declare function datumDate(d?: {
    date?: Date;
    localDate?: string;
    localTime?: string;
    created?: string;
 ...
 */
export declare function timeNormalizeDataArray(data: {
    date: Date;
 ...
 */
export declare function normalizeNestedStackDataByDate(layerData: {
    key: string;
    values: {
        date: Date;
    }[];
}[], fillTemplate?: Record<string, any>, fillFn?: (datum: Record<string, any>, key: string, prevDatum?: Record<string, any>) => void): void;
/**
 ...
 */
export declare function aggregateNestedDataLayers(layerData: {
    key: string;
    values: Record<string, any>[];
}[], resultKey: string, copyProperties?: string[], sumProperties?: string[], staticProperties?: Record<string, any>): {
    key: string;
    values: Record<string, any>[];
}[];
/**
