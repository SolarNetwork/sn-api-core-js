...
import { default as Aggregations } from "../domain/aggregation.js";
 ...
 */
export const dateUrlFormat = (date) => {
 ...
 * @returns the formatted date
 */
export const localDateUrlFormat = (date) => {
 ...
 */
export function seasonForDate(date, local) {
