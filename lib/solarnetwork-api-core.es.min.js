...
function timeNormalizeDataArray(e, t) {
    ...
    for (var n = 0; n < e.length - 1; ) {
        var a = e[n], i = a.date.getTime(), s = i + r, o = e[n + 1].date.getTime();
        if (s < o) {
            for (var u = [ n + 1, 0 ], l = i + r; l < o; l += r) {
...
function rollingQueryDateRange(e, t, r) {
    ...
    var i, s, o, u;
    return r = r || new Date(), {
        start: e.compareTo(Aggregations.Hour) < 0 ? (i = a("numHours"), s = Aggregations.Hour, 
        o = n(utcMinute, r), u = Math.min(30, e.level / 60), o.setUTCMinutes(o.getUTCMinutes() + u - o.getUTCMinutes() % u, 0, 0), 
        utcHour.offset(o, -i)) : Aggregations.Month.equals(e) ? (i = a("numYears"), 
        s = Aggregations.Year, o = n(utcMonth, r), utcYear.offset(utcMonth.floor(r), -i)) : Aggregations.Day.equals(e) ? (i = a("numMonths"), 
        s = Aggregations.Month, o = n(utcDay, r), utcMonth.offset(utcDay.floor(r), -i)) : (i = a("numDays"), 
        s = Aggregations.Day, o = n(utcHour, r), utcDay.offset(utcHour.floor(o), -i)),
        end: o,
        timeUnit: s,
        timeCount: i,
        aggregate: e
...
function normalizeNestedStackDataByDate(e, t, r) {
    var n, a, i, s, o, u = 0, l = e.length - 1;
    if (0 < l) for (;u < max(e.map(function(e) {
        ...
        for (i = void 0, n = 0; n <= l; n++) if (!(e[n].values.length <= u) && (e[a = n < l ? n + 1 : 0].values.length <= u || e[n].values[u].date.getTime() < e[a].values[u].date.getTime())) {
            if (i = {
                ...
                sourceId: e[a].key
            }, t) for (s in t) Object.prototype.hasOwnProperty.call(t, s) && (i[s] = t[s]);
            r && (o = e[a].values.length > u ? u : 0 < u ? u - 1 : null, r(i, e[a].key, null !== o ? e[a].values[o] : void 0)), 
...
function aggregateNestedDataLayers(e, t, r, n, a) {
    var i, s, o, u, l, c, h, d = e.length, y = r ? r.length : 0, p = n ? n.length : 0, f = e[0].values.length;
    if (0 < f) {
        for (h = [], i = 0; i < f; i += 1) {
            if (u = e[0].values[i], c = {}, void 0 !== a) for (l in a) Object.prototype.hasOwnProperty.call(a, l) && (c[l] = a[l]);
            for (o = 0; o < y; o += 1) c[r[o]] = u[r[o]];
            for (o = 0; o < p; o += 1) c[n[o]] = 0;
            for (s = 0; s < d; s += 1) for (o = 0; o < p; o += 1) void 0 !== (l = e[s].values[i][n[o]]) && (c[n[o]] += l);
            h.push(c);
        }
        e = [ {
            key: t,
...
var nest = Object.freeze({
    ...
    return _createClass(t, [ {
        ...
        key: "toUriEncoding",
        value: function(a, i) {
            for (var s = this, o = "", u = 0, l = Object.keys(this.props); u < l.length; u++) !function() {
                var r = l[u], e = (0 < o.length && (o += "&"), s.props[r]), n = !1;
                if (i) {
                    var t = i(r, e);
                    if (null === t) return;
                    Array.isArray(t) && 1 < t.length && (r = t[0], e = t[1], 2 < t.length && (n = !!t[2]));
                }
                if ("function" == typeof e.toUriEncoding) return o += e.toUriEncoding(a ? encodeURIComponent(a) + "." + r : r);
                a && (o += encodeURIComponent(a) + "."), o += encodeURIComponent(r) + "=", 
                Array.isArray(e) ? e.forEach(function(e, t) {
                    0 < t && (o += n ? "&" + encodeURIComponent(r) + "=" : ","), 
                    e instanceof Enum && (e = e.name), o += encodeURIComponent(e);
                }) : (e instanceof Enum && (e = e.name), o += encodeURIComponent(e));
            }();
            return o;
        }
...
var DatumFilter = function() {
    ...
    return _createClass(r, [ {
        ...
        set: function(e) {
            this.prop(UserIdsKey$2, Array.isArray(e) ? e : null);
        }
    }, {
        key: "mostRecent",
        get: function() {
        ...
        set: function(e) {
            this.prop(TagsKey$1, Array.isArray(e) ? e : null);
        }
    }, {
        key: "location",
        get: function() {
...
function datumFilterUriEncodingPropertyMapper(e, t) {
    if (e === NodeIdsKey$1 || e === LocationIdsKey$1 || e === SourceIdsKey$2 || e === UserIdsKey$2) {
...
var KeyedEnum = function() {
...
}(), DatumSamplesTypeValues = Object.freeze([ new DatumSamplesType("Instantaneous", "i"), new DatumSamplesType("Accumulating", "a"), new DatumSamplesType("Status", "s"), new DatumSamplesType("Tag", "t") ]), DatumSamplesTypes = DatumSamplesType.enumsValue(DatumSamplesTypeValues), DatumStreamType = function() {
    _inherits(n, KeyedEnum);
    var r = _createSuper(n);
    function n(e, t) {
        return _classCallCheck(this, n), r.call(this, e, t);
    }
    return _createClass(n, null, [ {
        key: "enumValues",
        value: function() {
    ...
    function u(e, t, r, n, a, i, s, o) {
        _classCallCheck(this, u), this._streamId = e, this._zone = t, this._kind = r instanceof DatumStreamType ? r : DatumStreamTypes.Node, 
        this._objectId = n, this._sourceId = a, this._iNames = Array.isArray(i) ? i : void 0, 
        this._aNames = Array.isArray(s) ? s : void 0, this._sNames = Array.isArray(o) ? o : void 0, 
    ...
    return _createClass(u, [ {
        ...
        get: function() {
            ...
            var e = [];
            return 0 < this.instantaneousLength && (e = e.concat(this._iNames)), 
            0 < this.accumulatingLength && (e = e.concat(this._aNames)), e = 0 < this.statusLength ? e.concat(this._sNames) : e;
        }
    }, {
        key: "propertyNamesForType",
        value: function(e) {
            return DatumSamplesTypes.Instantaneous.equals(e) ? this._iNames : DatumSamplesTypes.Accumulating.equals(e) ? this._aNames : DatumSamplesTypes.Status.equals(e) ? this._sNames : null;
        }
    }, {
        key: "toJsonEncoding",
        value: function() {
            ...
            return 0 < this.instantaneousLength && (e.i = this._iNames), 0 < this.accumulatingLength && (e.a = this._aNames), 
            0 < this.statusLength && (e.s = this._sNames), JSON.stringify(e);
        }
    } ], [ {
        key: "nodeMetadata",
        value: function(e, t, r, n, a, i, s) {
            return new u(e, t, DatumStreamTypes.Node, r, n, a, i, s);
        }
    }, {
        key: "locationMetadata",
        value: function(e, t, r, n, a, i, s) {
            return new u(e, t, DatumStreamTypes.Location, r, n, a, i, s);
        }
    }, {
        key: "fromJsonEncoding",
        value: function(e) {
            return this.fromJsonObject(JSON.parse(e));
        }
    }, {
        key: "fromJsonObject",
        value: function(e) {
            var t, r, n, a;
            return e ? (t = DatumStreamType.valueOf(e.kind), r = Array.isArray(e.i) ? e.i : void 0, 
            n = Array.isArray(e.a) ? e.a : void 0, a = Array.isArray(e.s) ? e.s : void 0, 
            new u(e.streamId, e.zone, t, e.objectId, e.sourceId, r, n, a)) : null;
        }
    } ]), u;
}(), BitmaskEnum = function() {
    _inherits(n, Enum);
    var r = _createSuper(n);
    function n(e, t) {
    ...
    return _createClass(n, [ {
        ...
        value: function(e, t) {
            ...
            try {
                for (a.s(); !(r = a.n()).done; ) {
                    var i = r.value, s = i.bitmaskBitOffset;
                    0 <= s && 1 == (e >> s & 1) && n.add(i);
                }
            } catch (e) {
                a.e(e);
...
function stringMapToObject(e) {
    ...
    if (e) {
        ...
        try {
            for (n.s(); !(r = n.n()).done; ) {
                var a = _slicedToArray(r.value, 2), i = a[0], s = a[1];
                t[i] = s instanceof Map ? stringMapToObject(s) : s;
            }
        } catch (e) {
            n.e(e);
        } finally {
...
var SecurityPolicy = function() {
    function u(e, t, r, n, a, i, s, o) {
        ...
        this._nodeMetadataPaths = setOrNull(s), this._userMetadataPaths = setOrNull(o), 
        this.constructor === u && Object.freeze(this);
    }
    return _createClass(u, [ {
        key: "nodeIds",
    ...
    return _createClass(s, [ {
        key: "addMetadata",
        value: function(e) {
            return e instanceof DatumStreamMetadata && e.streamId && (this._metaList.push(e), 
            this._metaMap.set(e.streamId, e)), this;
        }
    }, {
        ...
        key: "metadataAt",
        value: function(e) {
            return e < this._metaList.length ? this._metaList[e] : void 0;
        }
    }, {
        key: "indexOfMetadataStreamId",
        value: function(e) {
            var t, r = 0, n = _createForOfIteratorHelper(this._metaList);
            try {
                for (n.s(); !(t = n.n()).done; ) {
                    if (t.value.streamId === e) return r;
                    r += 1;
                }
            } catch (e) {
                n.e(e);
        ...
        value: function(e) {
            return this._metaMap.get(e);
        }
    }, {
        key: "metadataForObjectSource",
        value: function(e, t) {
            var r, n = _createForOfIteratorHelper(this._metaMap.values());
            try {
                for (n.s(); !(r = n.n()).done; ) {
                    var a = r.value;
                    if (a.objectId === e && a.sourceId == t) return a;
                }
            } catch (e) {
                n.e(e);
            } finally {
        ...
        key: "toJsonEncoding",
        value: function() {
            var e, t = "[", r = _createForOfIteratorHelper(this._metaList);
            try {
                for (r.s(); !(e = r.n()).done; ) {
                    var n = e.value;
                    1 < t.length && (t += ","), t += n.toJsonEncoding();
                }
            } catch (e) {
                r.e(e);
            } finally {
        ...
        key: "fromJsonEncoding",
        value: function(e) {
            if (e) return this.fromJsonObject(JSON.parse(e));
        }
    }, {
        key: "fromJsonObject",
        value: function(e) {
            if (Array.isArray(e)) {
                var t, r = new s(), n = _createForOfIteratorHelper(e);
                try {
                    for (n.s(); !(t = n.n()).done; ) {
                        var a = t.value, i = DatumStreamMetadata.fromJsonObject(a);
                        i && r.addMetadata(i);
                    }
                } catch (e) {
                    n.e(e);
...
function populateProperties$1(e, t, r, n) {
    if (Array.isArray(t) && Array.isArray(r)) for (var a, i, s, o = 0, u = Math.min(t.length, r.length); o < u; o += 1) a = r[o], 
    DatumSamplesTypes.Instantaneous === n ? Array.isArray(a) && (i = t[o], 0 < (s = a.length) && null !== a[0] && !Object.prototype.hasOwnProperty.call(e, i) && (e[i] = a[0], 
    1 < s && null !== a[1] && (e[i + "_count"] = a[1]), 2 < s && null !== a[2] && (e[i + "_min"] = a[2]), 
    3 < s && null !== a[3] && (e[i + "_max"] = a[3]))) : DatumSamplesTypes.Accumulating === n ? Array.isArray(a) && (i = t[o], 
    0 < (s = a.length) && null !== a[0] && !Object.prototype.hasOwnProperty.call(e, i) && (e[i] = a[0], 
    1 < s && null !== a[1] && (e[i + "_start"] = a[1]), 2 < s && null !== a[2] && (e[i + "_end"] = a[2]))) : null != a && (i = t[o], 
    Object.prototype.hasOwnProperty.call(e, i) || (e[i] = a));
}

var StreamAggregateDatum = function() {
    function s(e, t, r, n, a, i) {
        _classCallCheck(this, s), this.streamId = e, this.ts = Array.isArray(t) ? t.map(function(e) {
            return e instanceof Date ? e : new Date(e);
        }) : [], this.iProps = r, this.aProps = n, this.sProps = a, this.tags = i ? i instanceof Set ? i : new Set(i) : void 0, 
    ...
    return _createClass(s, [ {
        ...
        value: function(e) {
            ...
            return 0 < this.ts.length && (t.date = this.ts[0], 1 < this.ts.length && (t.date_end = this.ts[1])), 
            void 0 !== e.nodeId ? t.nodeId = e.nodeId : void 0 !== e.locationId && (t.locationId = e.locationId), 
            this.tags && (t.tags = Array.from(this.tags)), populateProperties$1(t, e.instantaneousNames, this.iProps, DatumSamplesTypes.Instantaneous), 
            populateProperties$1(t, e.accumulatingNames, this.aProps, DatumSamplesTypes.Accumulating), 
            populateProperties$1(t, e.statusNames, this.sProps, DatumSamplesTypes.Status), 
            t;
        }
    }, {
        key: "toJsonEncoding",
        value: function(e) {
            return JSON.stringify(this.toJsonObject(e));
        }
    }, {
        key: "toJsonObject",
        value: function(e) {
            e = [ e instanceof DatumStreamMetadataRegistry ? e.indexOfMetadataStreamId(this.streamId) : this.streamId, this.ts.map(function(e) {
                return e ? e.getTime() : null;
            }) ];
            return pushProperties$1(e, this.iProps), pushProperties$1(e, this.aProps), 
            pushProperties$1(e, this.sProps), pushProperties$1(e, this.tags), e;
        }
    } ], [ {
        key: "fromJsonEncoding",
        value: function(e, t) {
            return this.fromJsonObject(JSON.parse(e), t);
        }
    }, {
        key: "fromJsonObject",
        value: function(e, t) {
            var r, n, a, i, s, o, u;
            return Array.isArray(e) && 1 < e.length ? (r = 2, 0 < (n = (a = "string" == typeof e[0] ? t instanceof DatumStreamMetadata ? t : t.metadataForStreamId(e[0]) : t instanceof DatumStreamMetadata ? t : t.metadataAt(e[0])).instantaneousLength) && (i = e.slice(r, r + n), 
            r += n), 0 < (n = a.accumulatingLength) && (s = e.slice(r, r + n), r += n), 
            0 < (n = a.statusLength) && (o = e.slice(r, r + n), r += n), r < e.length && (u = new Set(e.slice(r))), 
            new this(a.streamId, e[1], i, s, o, u, t)) : null;
        }
    } ]), s;
}();

function pushProperties(e, t) {
    if (t) {
        var r, n = _createForOfIteratorHelper(t);
        try {
            for (n.s(); !(r = n.n()).done; ) {
...
function populateProperties(e, t, r) {
    if (Array.isArray(t) && Array.isArray(r)) for (var n, a, i = 0, s = Math.min(t.length, r.length); i < s; i += 1) null != (n = r[i]) && (a = t[i], 
    Object.prototype.hasOwnProperty.call(e, a) || (e[a] = n));
}

var StreamDatum = function() {
    function s(e, t, r, n, a, i) {
        _classCallCheck(this, s), this.streamId = e, this.ts = t instanceof Date ? t : new Date(t), 
        this.iProps = r, this.aProps = n, this.sProps = a, this.tags = i ? i instanceof Set ? i : new Set(i) : void 0, 
        this.constructor === s && Object.freeze(this);
    }
    return _createClass(s, [ {
        ...
        value: function(e) {
            return DatumSamplesTypes.Instantaneous.equals(e) ? this.iProps : DatumSamplesTypes.Accumulating.equals(e) ? this.aProps : DatumSamplesTypes.Status.equals(e) ? this.sProps : DatumSamplesTypes.Tags.equals(e) ? this.tags : void 0;
        }
    }, {
        key: "toObject",
        value: function(e) {
            ...
            return void 0 !== e.nodeId ? t.nodeId = e.nodeId : void 0 !== e.locationId && (t.locationId = e.locationId), 
            this.tags && (t.tags = Array.from(this.tags)), populateProperties(t, e.instantaneousNames, this.iProps), 
            populateProperties(t, e.accumulatingNames, this.aProps), populateProperties(t, e.statusNames, this.sProps), 
            t;
        }
    }, {
        key: "toJsonEncoding",
        ...
        key: "toJsonObject",
        value: function(e) {
            e = [ e instanceof DatumStreamMetadataRegistry ? e.indexOfMetadataStreamId(this.streamId) : this.streamId, this.ts.getTime() ];
            return pushProperties(e, this.iProps), pushProperties(e, this.aProps), 
            pushProperties(e, this.sProps), pushProperties(e, this.tags), e;
        }
    } ], [ {
        key: "fromJsonEncoding",
        value: function(e, t) {
        ...
        value: function(e, t) {
            var r, n, a, i, s, o, u, l;
            return Array.isArray(e) && 1 < e.length ? (a = "string" == typeof e[0] ? t instanceof DatumStreamMetadata ? t : t.metadataForStreamId(e[0]) : t instanceof DatumStreamMetadata ? t : t.metadataAt(e[0]), 
            i = new Date(e[1]), r = 2, 0 < (n = a.instantaneousLength) && (s = e.slice(r, r + n), 
            r += n), 0 < (n = a.accumulatingLength) && (o = e.slice(r, r + n), r += n), 
            0 < (n = a.statusLength) && (u = e.slice(r, r + n), r += n), r < e.length && (l = new Set(e.slice(r))), 
            new this(a.streamId, i, s, o, u, l, t)) : null;
        }
    } ]), s;
}(), StreamDatumMetadataMixin = function(e) {
    return function() {
        _inherits(i, e);
        ...
        function i() {
            ...
            return e = a.call.apply(a, [ this ].concat(r)), 0 < r.length && r[r.length - 1] instanceof DatumStreamMetadata && (e._meta = r[r.length - 1]), 
            Object.freeze(_assertThisInitialized(e)), e;
        }
        return _createClass(i, [ {
            ...
            key: "toObject",
            value: function() {
                return _get(_getPrototypeOf(i.prototype), "toObject", this).call(this, this._meta);
            }
        } ]), i;
    }();
}, AggregateDatum = function() {
    _inherits(t, StreamDatumMetadataMixin(StreamAggregateDatum));
    ...
    _inherits(t, StreamDatumMetadataMixin(StreamDatum));
    var e = _createSuper(t);
    function t() {
        return _classCallCheck(this, t), e.apply(this, arguments);
    }
    return _createClass(t);
}(), TagsKey = "tags", UserIdsKey$1 = "userIds", UserMetadataFilter = function() {
    _inherits(r, PropMap);
    var t = _createSuper(r);
    function r(e) {
        return _classCallCheck(this, r), t.call(this, e);
    ...
    return _createClass(r, [ {
        ...
        key: "toUriEncoding",
        value: function(e, t) {
            return _get(_getPrototypeOf(r.prototype), "toUriEncoding", this).call(this, e, t || userMetadataFilterUriEncodingPropertyMapper);
        }
    } ]), r;
}();

function userMetadataFilterUriEncodingPropertyMapper(e, t) {
    return e === UserIdsKey$1 && Array.isArray(t) && 1 === t.length ? [ e.substring(0, e.length - 1), t[0] ] : e;
}
...
function addValue(e, t, r, n) {
    ...
    if (i || (e.mappings[a] = i = {
        key: t,
        val: []
    }, e.mappingNames.push(a)), n && (i.val.length = 0), Array.isArray(r)) for (var s = r.length, o = 0; o < s; o += 1) i.val.push(r[o]); else i.val.push(r);
    return e;
}
...
function urlQueryParse(e, t) {
    var r, n, a, i, s, o = {};
    if (void 0 !== e && 0 < e.length) for (n = 0, a = (r = (e = e.match(/^\?/) ? e.substring(1) : e).split("&")).length; n < a; n++) 2 === (s = r[n].split("=", 2)).length && (i = decodeURIComponent(s[0]), 
    s = decodeURIComponent(s[1]), o[i] ? (Array.isArray(o[i]) || (o[i] = [ o[i] ]), 
    o[i].push(s)) : t && t.has(i) ? o[i] = [ s ] : o[i] = s);
    return o;
}

function urlQueryEncode(e, t) {
    var r, n, a, i, s = "", o = t || encodeURIComponent;
    function u(e, t) {
        s.length && (s += "&"), s += o(e) + "=" + o(t);
    }
...
var urlQuery = {
    ...
    return _createClass(r, [ {
        ...
        value: function() {
            ...
            e.sort();
            for (var t = e.length, r = !0, n = "", a = 0; a < t; a += 1) for (var i = e[a], s = this.parameters.value(i), o = s.length, u = 0; u < o; u += 1) r ? r = !1 : n += "&", 
            n += _encodeURIComponent(i) + "=" + _encodeURIComponent(s[u]);
            return n;
        }
    }, {
...
function datumForStreamData(e, t) {
    return "string" == typeof e && (e = JSON.parse(e)), !Array.isArray(e) || e.length < 2 ? null : (Array.isArray(e[1]) ? AggregateDatum : Datum).fromJsonObject(e, t);
}

function streamDatumForData(e, t) {
    return "string" == typeof e && (e = JSON.parse(e)), !Array.isArray(e) || e.length < 2 ? null : (Array.isArray(e[1]) ? StreamAggregateDatum : StreamDatum).fromJsonObject(e, t);
}
