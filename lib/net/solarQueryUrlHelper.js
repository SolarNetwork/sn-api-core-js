 ...
 */
export default class SolarQueryApi extends DatumMetadataUrlHelperMixin(DatumUrlHelperMixin(NodesUrlHelperMixin(NodeMetadataUrlHelperMixin(SolarQueryUrlHelper)))) {
}
/**
