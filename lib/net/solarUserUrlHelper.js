 ...
 */
export default class SolarUserApi extends AuthUrlHelperMixin(AuthTokenUrlHelperMixin(InstructionUrlHelperMixin(UserDatumAuxiliaryUrlHelperMixin(UserMetadataUrlHelperMixin(UserNodesUrlHelperMixin(SolarUserUrlHelper)))))) {
}
