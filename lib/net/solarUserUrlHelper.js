 ...
 */
export default class SolarUserApi extends AuthUrlHelperMixin(AuthTokenUrlHelperMixin(NodeMetadataUrlHelperMixin(InstructionUrlHelperMixin(UserDatumAuxiliaryUrlHelperMixin(UserMetadataUrlHelperMixin(UserNodesUrlHelperMixin(SolarUserUrlHelper))))))) {
}
