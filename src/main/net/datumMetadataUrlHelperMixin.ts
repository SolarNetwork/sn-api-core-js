 ...
 * @ignore
 */
const DatumMetadataUrlHelperMixin = <T extends UrlHelperConstructor>(
	superclass: T
) =>
	/**
	...
	class DatumMetadataUrlHelperMixin extends superclass {
		...
		#datumMetadataUrlWithSource(nodeId?: number, sourceId?: string) {
