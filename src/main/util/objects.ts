 ...
 */
function stringMapToObject(strMap: Map<string, any>): object {
 ...
 */
function objectToStringMap(obj: object): Map<string, any> {
 ...
 */
function nonEmptySet<T>(obj?: T[] | Set<T> | T): Set<T> | undefined {
