...
import NodeUrlHelperMixin from "../../src/net/nodeUrlHelperMixin.js";
import UserUrlHelperMixin from "../../src/net/userUrlHelperMixin.js";
...
test("net:user:userUrlHelperMixin:viewPendingNodesUrl", (t) => {
	...
	t.is(
		...
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/pending",
	);
});
...
test("net:user:userUrlHelperMixin:nimAuthorizeUrl", (t) => {
	const helper = new UserUrlHelper();
	t.is(
		helper.nimAuthorizeUrl(),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/user/nim/authorize",
	);
});
...
test("net:user:userUrlHelperMixin:updateNodeArchivedStatusUrl", (t) => {
	...
	helper.nodeId = 123;
	t.is(
		helper.updateNodeArchivedStatusUrl(),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/archived?" +
			"nodeIds=123&archived=false",
	);
	t.is(
		helper.updateNodeArchivedStatusUrl(234),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/archived?" +
			"nodeIds=234&archived=false",
	);
	t.is(
		helper.updateNodeArchivedStatusUrl([234, 456]),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/archived?" +
			"nodeIds=234,456&archived=false",
	);
	t.is(
		helper.updateNodeArchivedStatusUrl(234, true),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/archived?" +
