...
import { NodeDatumMetadataUrlHelper } from "../../src/net/nodeDatumMetadataUrlHelperMixin.js";
...
test("core:net:nodeDatumMetadataUrlHelperMixin:viewNodeDatumMetadataUrl:sourceIdParam", (t) => {
	...
	t.is(
		result,
		"https://data.solarnetwork.net/solarquery/api/v1/sec/datum/meta/null?sourceId=foo",
	);
});
...
test("core:net:nodeDatumMetadataUrlHelperMixin:findNodeDatumMetadataUrl:sorted", (t) => {
	const helper = new NodeDatumMetadataUrlHelper();
	t.is(
		helper.findNodeDatumMetadataUrl(123, "foo", [new SortDescriptor("bar")]),
		"https://data.solarnetwork.net/solarquery/api/v1/sec/datum/meta/123?" +
			"sourceId=foo&sorts%5B0%5D.key=bar",
	);
	t.is(
		helper.findNodeDatumMetadataUrl(123, "foo", [new SortDescriptor("bar", true)]),
		"https://data.solarnetwork.net/solarquery/api/v1/sec/datum/meta/123?" +
...
test("core:net:nodeDatumMetadataUrlHelperMixin:findNodeDatumMetadataUrl:paginated", (t) => {
	const helper = new NodeDatumMetadataUrlHelper();
	t.is(
		helper.findNodeDatumMetadataUrl(123, "foo", null, new Pagination(1, 2)),
		"https://data.solarnetwork.net/solarquery/api/v1/sec/datum/meta/123?" +
...
test("user:net:nodeDatumMetadataUrlHelperMixin:viewUserMetadataUrl:argNull", (t) => {
	const helper = new NodeDatumMetadataUrlHelper();
	helper.userId = 123;
