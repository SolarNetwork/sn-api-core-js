...
import { dateFormat } from "../../src/format/date.js";
import AuthTokenUrlHelperMixin from "../../src/net/authTokenUrlHelperMixin.js";
import NodeUrlHelperMixin from "../../src/net/authTokenUrlHelperMixin.js";
import QueryUrlHelperMixin from "../../src/net/queryUrlHelperMixin.js";
import UrlHelper from "../../src/net/urlHelper.js";

class TestUrlHelper extends AuthTokenUrlHelperMixin(
...
test("net:authTokenUrlHelperMixin:refreshV2Url", (t) => {
	...
	t.is(
		...
		"https://data.solarnetwork.net/solarquery/api/v1/sec/auth-tokens/refresh/v2?date=1970-01-01",
	);
});
...
test("net:authTokenUrlHelperMixin:refreshV2Url:today", (t) => {
	...
	t.is(
		...
		`https://data.solarnetwork.net/solarquery/api/v1/sec/auth-tokens/refresh/v2?date=${expectedDateParam}`,
	);
});
