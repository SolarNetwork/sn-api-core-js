...
import { NodeMetadataUrlHelper } from "../../src/net/nodeMetadataUrlHelperMixin.js";
...
test("core:net:nodeMetadataUrlHlperMixin:findNodeMetadataUrl:sorted", (t) => {
	...
	helper.nodeId = 123;
	t.is(
		helper.findNodeMetadataUrl(234, [new SortDescriptor("foo")]),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/meta?" +
			"nodeIds=234&sorts%5B0%5D.key=foo",
	);
	t.is(
		helper.findNodeMetadataUrl(234, [new SortDescriptor("foo", true)]),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/meta?" +
...
test("core:net:nodeMetadataUrlHlperMixin:findNodeMetadataUrl:paginated", (t) => {
	...
	helper.nodeId = 123;
	t.is(
		helper.findNodeMetadataUrl(234, null, new Pagination(1, 2)),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/meta?" +
...
test("core:net:nodeMetadataUrlHlperMixin:findNodeMetadataUrl:sortedAndPaginated", (t) => {
	...
	helper.nodeId = 123;
	t.is(
		helper.findNodeMetadataUrl(234, [new SortDescriptor("foo")], new Pagination(1, 2)),
		"https://data.solarnetwork.net/solaruser/api/v1/sec/nodes/meta?" +
