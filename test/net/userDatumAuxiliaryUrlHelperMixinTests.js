...
import { UserDatumAuxiliaryUrlHelper } from 'net/userDatumAuxiliaryUrlHelperMixin'
import DatumFilter from 'domain/datumFilter'
import DatumAuxiliaryTypes from 'domain/datumAuxiliaryType';
...
test('net:userDatumAuxiliaryUrlHelperMixin:idUrl:typical', t => {
	const helper = new UserDatumAuxiliaryUrlHelper();
	const result = helper.userDatumAuxiliaryIdUrl(DatumAuxiliaryTypes.Reset, 123, new Date('2017-01-01T12:12:12.123Z'), 'Foo');
	t.is(result, 'https://data.solarnetwork.net/solaruser/api/v1/sec/datum/auxiliary/Reset/123/2017-01-01%2012%3A12%3A12.123Z/Foo');
});

test('net:userDatumAuxiliaryUrlHelperMixin:idUQueryrl:typical', t => {
	const helper = new UserDatumAuxiliaryUrlHelper();
	const result = helper.userDatumAuxiliaryIdQueryUrl(DatumAuxiliaryTypes.Reset, 123, new Date('2017-01-01T12:12:12.123Z'), '/foo/bar');
    t.is(result, 'https://data.solarnetwork.net/solaruser/api/v1/sec/datum/auxiliary'
...
test('net:userDatumAuxiliaryUrlHelperMixin:idUrl:queryForced', t => {
	const helper = new UserDatumAuxiliaryUrlHelper();
	const result = helper.userDatumAuxiliaryIdUrl(DatumAuxiliaryTypes.Reset, 123, new Date('2017-01-01T12:12:12.123Z'), '/foo/bar');
    t.is(result, 'https://data.solarnetwork.net/solaruser/api/v1/sec/datum/auxiliary'
        +'?type=Reset&nodeId=123&date=2017-01-01%2012%3A12%3A12.123Z&sourceId=%2Ffoo%2Fbar');
});
...
test('net:userDatumAuxiliaryUrlHelperMixin:store:typical', t => {
	const helper = new UserDatumAuxiliaryUrlHelper();
	const result = helper.storeUserDatumAuxiliaryUrl(DatumAuxiliaryTypes.Reset, 123, new Date('2017-01-01T12:12:12.123Z'), 'Foo');
	t.is(result, 'https://data.solarnetwork.net/solaruser/api/v1/sec/datum/auxiliary/Reset/123/2017-01-01%2012%3A12%3A12.123Z/Foo');
});

test('net:userDatumAuxiliaryUrlHelperMixin:view:typical', t => {
	const helper = new UserDatumAuxiliaryUrlHelper();
	const result = helper.viewUserDatumAuxiliaryUrl(DatumAuxiliaryTypes.Reset, 123, new Date('2017-01-01T12:12:12.123Z'), 'Foo');
	t.is(result, 'https://data.solarnetwork.net/solaruser/api/v1/sec/datum/auxiliary/Reset/123/2017-01-01%2012%3A12%3A12.123Z/Foo');
});

test('net:userDatumAuxiliaryUrlHelperMixin:delete:typical', t => {
	const helper = new UserDatumAuxiliaryUrlHelper();
	const result = helper.deleteUserDatumAuxiliaryUrl(DatumAuxiliaryTypes.Reset, 123, new Date('2017-01-01T12:12:12.123Z'), 'Foo');
	t.is(result, 'https://data.solarnetwork.net/solaruser/api/v1/sec/datum/auxiliary/Reset/123/2017-01-01%2012%3A12%3A12.123Z/Foo');
});
